    ...
    <div className="py-32 md:py-40 px-5 md:px-10 relative overflow-hidden text-center bg-background" id="cta">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="relative z-10 max-w-full mx-auto px-4 md:px-16 lg:px-24">
        ...
        <div className="flex gap-4 md:gap-6 justify-center flex-wrap">
          ...
          <button className="px-12 md:px-16 py-4 md:py-5 bg-transparent text-foreground text-[.88rem] md:text-[1rem] font-normal border-[1.5px] border-border rounded-full cursor-none hover:border-gold hover:text-gold hover:translate-y-[-3px] transition-all duration-250">Download Capability Deck</button>
        </div>
      </motion.div>
    </div>
  );
